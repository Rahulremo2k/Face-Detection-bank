...
class BankUi:
    def __init__(self,root):
        self.root = root
        self.header = Label(self.root,text="Reserve Bank of India",bg="#000000",fg="white",font=("arial",20,"bold"))
    ...
    def begin_page(self):
        ...
        self.withdraw = Button(self.frame, text="Withdraw Money",bg="#3372de",fg="white",font=ARIAL,command=self.withdraw_money_page)
        self.q = Button(self.frame, text="Quit", bg="#3372de", fg="white", font=ARIAL, command=self.root.destroy)
        self.enroll.place(x=360, y=240, width=200, height=50)
        self.withdraw.place(x=360, y=340, width=200, height=50)
    ...
    def withdraw_money_page(self):
        ...
        self.label1 =Label(self.frame,text="Note:",bg="#ffffff",fg="black",font=ARIAL)
        self.label2 =Label(self.frame,text="1.By clicking on the 'Verify Face Id' button, we proceed to perform facial recognition.",bg="#ffffff",fg="black",font=ARIAL)
        self.label3 =Label(self.frame,text="2.Each capture will take 15 seconds are you are required to move your face in different directions while being captured.",bg="#ffffff",fg="black",font=ARIAL)
        self.label4 =Label(self.frame,text="3.If your face is recognized, you will be required to input your account password:",bg="#ffffff",fg="black",font=ARIAL)
        self.label5 =Label(self.frame,text="4. If your face is not reconized after 5 seconds, you will automatically be given 2 trial more.",bg="#ffffff",fg="black",font=ARIAL)
        self.label6 =Label(self.frame,text="5.If your face is not recognized after three trials, you wont be allowed to withdraw",bg="#ffffff",fg="black",font=ARIAL)
        self.label7 =Label(self.frame,text="6.To begin, click the 'Verify Face Id' button below",bg="#ffffff",fg="black",font=ARIAL)
        self.button = Button(self.frame,text="Verify Face Id",bg="#3372de",fg="white",font=ARIAL,command=self.video_check)
        self.q = Button(self.frame,text="Quit",bg="#3372de",fg="white",font=ARIAL,command = self.root.destroy)
        self.b = Button(self.frame,text="Back",bg="#3372de",fg="white",font=ARIAL,command = self.begin_page)
        self.label1.place(x=30,y=80,width=800,height=20)
        self.label2.place(x=60,y=100,width=800,height=20)
        self.label3.place(x=60,y=120,width=800,height=20)
        self.label4.place(x=60,y=140,width=800,height=20)
        self.label5.place(x=60,y=160,width=800,height=20)
        self.label6.place(x=60,y=180,width=800,height=20)
        self.label7.place(x=60,y=200,width=800,height=20)
        self.button.place(x=390, y=250, width=130, height=30)
    ...
    def enroll_user(self):
        ...
        self.frame = Frame(self.root,bg="#ffffff",width=900,height=600)
        #Login Page Form Components
        self.userlabel =Label(self.frame,text="Full Name",bg="#ffffff",fg="black",font=ARIAL)
        self.uentry = Entry(self.frame,bg="#ffffff",highlightcolor="#c3c7c7",
           highlightthickness=2,
            highlightbackground="white")
        self.plabel = Label(self.frame, text="Password",bg="#ffffff",fg="black",font=ARIAL)
    ...
    def video_capture_page(self):
        ...
        #Login Page Form Components
        self.label1 =Label(self.frame,text="Note:",bg="#ffffff",fg="black",font=ARIAL)
        self.label2 =Label(self.frame,text="1.By clicking on the 'Capture' button below, your image gets captured ",bg="#ffffff",fg="black",font=ARIAL)
        self.label3 =Label(self.frame,text="2.You will be required to capture 5 images for full registration",bg="#ffffff",fg="black",font=ARIAL)
        self.label4 =Label(self.frame,text="3.To capture each image click the space bar on your keyboard when the camera turn on:",bg="#ffffff",fg="black",font=ARIAL)
        self.label5 =Label(self.frame,text="4. Please wait till you are notified that your capture was successful before leaving the page",bg="#ffffff",fg="black",font=ARIAL)
        data = pd.read_csv('bank_details.csv')
        self.label6 =Label(self.frame,text="5.To begin, click the 'Capture' button below and click the space bar to capture a new image",bg="#ffffff",fg="black",font=ARIAL)
        self.button = Button(self.frame,text="Capture",bg="#3372de",fg="white",font=ARIAL,command=self.captureuser)
        
        self.label1.place(x=50,y=100,width=100,height=20)
        self.label2.place(x=100,y=140,width=600,height=20)
        self.label3.place(x=100,y=160,width=600,height=20)
        self.label4.place(x=100,y=180,width=600,height=20)
        self.label5.place(x=100,y=200,width=600,height=20)
        self.label6.place(x=100,y=220,width=600,height=20)
...
root = Tk()
root.title("Reserve Bank of India")
